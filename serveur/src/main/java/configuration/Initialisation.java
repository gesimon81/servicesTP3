...
public class Initialisation {
	...
	public static HyperLien<Bibliotheque> biblio(HyperLien<?> h){
		return new HyperLien<>(UriBuilder.fromUri(h.getUri()).path(JAXRS.CHEMIN_BIBLIO).build());
	}
	/*
	 * Hyperliens vers les bibliotheques.
	 */
	public static List<HyperLien<Bibliotheque>> bibliotheques() {
		List<HyperLien<Bibliotheque>> l = new LinkedList<>();
